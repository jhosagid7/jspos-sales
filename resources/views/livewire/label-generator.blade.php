                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label font-weight-bold text-dark" for="templateLargeQr">
                                                <i class="fas fa-qrcode text-success me-1"></i> Grande (Código QR - 3x6)
                                                <small class="d-block text-muted">18 etiquetas por hoja con nombre de producto grande, datos de operador/fecha visibles y Código QR 2D.</small>
                                            </label>
                                        </div>
                                    </div>
                                </div>
