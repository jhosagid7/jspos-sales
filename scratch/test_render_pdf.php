...
// Check if references are in the rendered HTML
$references = ['51989', '97527', '57778', '76704', '48869', 'g20pjj7ni'];

echo "=== RENDER CHECK ===\n";
foreach ($references as $ref) {
    $found = strpos($html, $ref) !== false;
    echo "Reference $ref found in HTML: " . ($found ? "YES" : "NO") . "\n";
}
