...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             */
            'compression_method' => defined('\ZipArchive::CM_DEFAULT') ? \ZipArchive::CM_DEFAULT : 1,
     ...
     */
    'notifications' => [
        'notifications' => env('BACKUP_MAIL_ENABLED', false) ? [
        ...
        'mail' => [
            'to' => array_filter(array_map('trim', explode(',', env('BACKUP_MAIL_TO', 'jhosagid7@gmail.com')))),
