    ...
    <table class="table">
        ...
        <tbody>
            ...
            @foreach($sales as $sale)
                ...
                <tr>
                    ...
                    <td class="text-center">{{ number_format($surchargePercent, 1) }}%</td>
                    ...
                    <td class="text-right text-bold">${{ number_format($sale->total_usd, 2) }}</td>
                    <td class="text-right">
                        @if($creditUSD > 0.01)
        ...
        <tfoot>
            <tr class="totals-row">
                ...
                <td class="text-right">${{ number_format($totBase, 2) }}</td>
                <td></td>
                <td class="text-right text-green">${{ number_format($totComm, 2) }}</td>
                <td class="text-right text-blue">${{ number_format($totFreight, 2) }}</td>
                <td class="text-right text-orange">${{ number_format($totDiff, 2) }}</td>
                <td class="text-right">${{ number_format($totTotal, 2) }}</td>
                <td class="text-right text-red">${{ number_format($totCredit, 2) }}</td>
                <td class="text-center">{{ $totItems }}</td>
                <td colspan="3"></td>
            </tr>
        </tfoot>
    </table>
