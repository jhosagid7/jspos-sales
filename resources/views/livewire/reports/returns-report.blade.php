                ...
                <div class="row">
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            <label>Folio / Nro Nota</label>
                            <input type="text" wire:model.live="searchFolio" class="form-control" placeholder="Ej: NC-101">
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-1">
                                        @if($r->status == 'pending')
                                            ...
                                            @endcan
                                        @endif
                                        <a href="{{ url('sales-detail/' . $r->sale_id) }}" target="_blank" class="btn btn-dark btn-sm" title="Ver Factura">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                    </div>
                                    @if($r->status == 'approved' && $r->approver)
                                        <div class="mt-1">
                                            <small class="text-muted">Por: {{ $r->approver->name }}</small>
                                        </div>
                                    @endif
                                </td>
                            </tr>
