...
return new class extends Migration
{
    ...
    {
        Schema::create('sale_change_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('sale_id');
            $table->string('currency_code', 3); // Código de la moneda (USD, COP, etc.)
            $table->decimal('amount', 15, 2); // Monto del vuelto en esa moneda
    ...
    {
        Schema::dropIfExists('sale_change_details');
    }
};
