...
.clase_table {
    ...
    <body>
        @php
            ...
            $showSellerBanks = $config ? $config->getPdfSetting('sales_credit', 'show_seller_banks', true) : true;
            ...
            $showQr = $config ? $config->getPdfSetting('sales_credit', 'show_qr', true) : true;
            $showFooterCode = $config ? $config->getPdfSetting('sales_credit', 'show_footer_code', true) : true;
        @endphp
